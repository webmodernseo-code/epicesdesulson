  ...
  <div class="doc-container">
    ...
    <div class="header-block">
      <div class="brand-eyebrow">
        <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
    ...
    <div class="section-block page-break">
      ...
      <div class="editorial-box">
        <h4>
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#065f46" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
...
console.log('✓ Refactored pure SVG HTML guide written to:', htmlFilePath);
...
try {
  ...
  if (fs.existsSync(pdfFilePath)) {
    ...
    console.log(`✓ Ultra-premium PDF successfully generated (${(stats.size / 1024).toFixed(1)} KB):`);
