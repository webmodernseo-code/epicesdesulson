...
export default function FrequentlyBoughtItems() {
  return (
      ...
      <div className="container">
        <div className="flex items-center justify-between mb-12">
          ...
          <div className="flex items-center gap-x-6">
            <button className="frequently-products-5-prev size-12 bg-[rgba(145,158,171,0.08)] text-light-primary-text flex items-center justify-center rounded-full   hover:bg-primary hover:text-white transition-colors">
              <i className="hgi hgi-stroke hgi-arrow-left-01 text-[22px] " />
            </button>
            <button className="frequently-products-5-next size-12 bg-[rgba(145,158,171,0.08)] flex items-center justify-center rounded-full text-light-primary-text  hover:bg-primary hover:text-white transition-colors">
