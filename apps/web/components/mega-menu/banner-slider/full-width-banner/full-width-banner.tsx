...
const BANNER_SLIDES = [
  {
    id: 1,
    bgImage: "/images/full-banner/banner-5.png",
        ...
        >
          {BANNER_SLIDES.map((slide) => (
            <SwiperSlide key={slide.id}>
              <div
                className="lg:p-0 p-8 pb-15 bg-center bg-no-repeat bg-cover rounded-3xl xl:pr-[123px] lg:pr-20 flex items-center h-[520px]"
