export default function SizeVariationDrawer() {
  return (
    <div
      data-state="close"
      ...
      <div className="size-variation-modal-content">
        <h5 className="size-variation-modal-title py-[15px] px-6 border-b border-gray-300 relative">
          ...
          <button
            ...
            className="absolute top-1/2 -translate-y-1/2 right-6 close-sidebar-btn"
          >
        ...
        <div className="size-variation-modal-content-inner p-[34px]">
          <div className="height-range-slider-section mb-6 flex items-center gap-x-10">
            <div className="flex items-center gap-x-6">
              <span>Height:</span>
              <p className="py-2.5 px-3.5 border border-gray-300 rounded-[80px] font-semibold text-light-primary-text min-w-21">
                <span className="height-range-slider-value">150</span>
                <span>cm</span>
              </p>
            </div>
            <div className="flex-1" id="height-range-slider" />
          </div>
          <div className="weight-range-slider-section mb-6 flex items-center gap-x-10">
            <div className="flex items-center gap-x-6">
              <span>Weight:</span>
              <p className="py-2.5 px-3.5 border border-gray-300 rounded-[80px] font-semibold text-light-primary-text min-w-21">
                <span className="weight-range-slider-value">150</span>
                <span>kg</span>
              </p>
            </div>
            <div className="flex-1" id="weight-range-slider" />
          </div>
