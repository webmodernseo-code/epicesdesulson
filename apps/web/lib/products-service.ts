...
export const SULSON_CATALOGUE: SulsonProductModel[] = [
  {
    ...
    formats: [
      { label: "Sachet 100g", weightGrams: 100, multiplier: 1, price: 5.99, oldPrice: 7.50 },
      { label: "Pack 4 Saveurs 400g", weightGrams: 400, multiplier: 4, price: 23.96, oldPrice: 29.90 },
    ],
  },
  {
    id: "302",
  ...
  },
  {
    ...
    formats: [
      { label: "Pack Intégral 4x100g (400g)", weightGrams: 400, multiplier: 1, price: 23.96, oldPrice: 29.90 },
    ],
  },
];
