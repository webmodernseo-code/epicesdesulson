...
import { Sparkles, ChevronRight, CheckCircle2, ShoppingBag } from "lucide-react";
...
export default async function ProductsCataloguePage() {
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      {/* ── Hero Header ── */}
      <div className="bg-linear-to-b from-gray-900 to-gray-800 text-white py-14 sm:py-18">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product) => {
            ...
            return (
              <div
                key={product.id}
                className={`group bg-white rounded-3xl border border-gray-200/90 shadow-2xs hover:shadow-xl transition-all duration-300 flex flex-col overflow-hidden ${
