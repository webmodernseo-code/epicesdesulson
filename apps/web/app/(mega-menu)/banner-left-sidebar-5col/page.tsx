...
import BannerSliderOne from "@/components/mega-menu/banner-slider/banner-slider-one";
    ...
    <div>
      <Breadcrumb
        items={[
          ...
          { label: "5 Columns (Left Filter) with Banner" },
        ]}
      />
          ...
          <div className="grid grid-cols-12 lg:gap-x-6 gap-y-6">
            ...
            <div className="xl:col-span-9 lg:col-span-8 col-span-12 row-start-1 lg:row-start-auto">
              ...
              <motion.div
                ...
                className="flex items-center justify-between pt-12 pb-12"
              >
                <div className="flex items-center gap-x-4 shrink-0 justify-start">
                  ...
                  <div className="flex items-center gap-x-4">
                    <button
                      ...
                      className={`w-10 h-10 rounded-full inline-flex items-center justify-center border border-[rgba(145,158,171,0.24)] cursor-pointer ${viewMode === "list" ? "btn-primary text-white" : "bg-white text-black"}`}
                    >
                      <span className="inline-flex items-center justify-center">
                        <i
                          className={`hgi hgi-stroke hgi-left-to-right-list-bullet text-2xl leading-6 ${viewMode === "list" ? "text-white" : ""}`}
                        />
                      </span>
                    </button>
                    <button
                      onClick={() => setViewMode("grid")}
                      className={`w-10 h-10 rounded-full inline-flex items-center justify-center border border-[rgba(145,158,171,0.24)] cursor-pointer ${viewMode === "grid" ? "btn-primary text-white" : "bg-white text-black"}`}
                    >
                      <span className="inline-flex items-center justify-center">
                        <i
                          className={`hgi hgi-stroke hgi-more-01 text-2xl leading-6 ${viewMode === "grid" ? "text-white" : ""}`}
                        />
                      </span>
                    </button>
                  </div>
              ...
              <div
                className={
                  viewMode === "grid"
                    ? "grid 2xl:grid-cols-5 xl:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-6 pb-12"
