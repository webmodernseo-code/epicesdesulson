    ...
    <div>
      ...
      <div className="pb-[70px]">
        <div className="container">
          <VendorHeroWithSearch className="pb-12" />
              ...
              <div className="flex flex-col gap-y-4 sidebar sticky top-20">
                <div className="rounded-2xl border border-gray-300">
                  ...
                  <div className="pt-[40px] pb-6 px-6 flex flex-col gap-y-6 relative">
                    <div className="z-50 size-[64px] bg-transparent absolute top-[-36px] left-1/2 -translate-x-1/2 before:absolute before:left-1/2 before:-translate-x-1/2 before:top-0 before:z-[-1] before:w-[144px] before:h-[64px] before:bg-[url('/images/vendor-filter-top-shape.png')] before:bg-no-repeat">
                      <Image
