...
const VENDORS_DATA: Vendor[] = [
  ...
  {
    id: 4,
    bannerImage: "/images/vendors-list/vendor-4.png",
    profileImage: "/images/vendors-list/vendor-profile.png",
    companyName: "Wellness Center Hub",
    rating: 4.8,
    reviewCount: 312,
    phone: "(555) 321-0987",
    email: "info@wellnesshub.org",
    address: "321 Cedar Lane, Denver, CO, 80201, United States",
  },
  {
    id: 5,
    bannerImage: "/images/vendors-list/vendor-5.png",
    profileImage: "/images/vendors-list/vendor-profile.png",
    companyName: "VitaMart",
    rating: 3.5,
    reviewCount: 45,
    phone: "(555) 654-3210",
    email: "sales@vitamart.co",
    address: "654 Birch Street, Seattle, WA, 98101, United States",
  },
  {
    id: 6,
    bannerImage: "/images/vendors-list/vendor-6.png",
    profileImage: "/images/vendors-list/vendor-profile.png",
    companyName: "EcoHealth Solutions",
    rating: 4.9,
    reviewCount: 567,
    phone: "(555) 789-0123",
    email: "contact@ecohealth.com",
    address: "987 Maple Drive, Miami, FL, 33101, United States",
  },
];
...
export default function VendorsGridPage() {
  const [viewMode, setViewMode] = useState<"grid" | "list">("grid");

  return (
    <div>
      <Breadcrumb items={[{ label: "Vendors Grid" }]} />
        ...
        <div className="container">
          <div className="flex items-center justify-between pb-6 gap-y-4">
            ...
            <div className="flex items-center gap-x-4 flex-1 justify-end w-full md:w-auto">
              <div className="input-group medium max-w-[345px] h-10.5 pl-4 py-2 pr-2.5 rounded-[100px] flex-1 hidden lg:flex">
                <div
