...
export default function EditAttributeForm() {
  ...
  const [optionType, setOptionType] = useState(optionTypeOptions[0].value);
  const [category, setCategory] = useState(categoryOptions[1].value);

  // Pre-filled dummy data for demonstration
  return (
    <div className="w-full bg-white rounded-2xl p-4 sm:p-6 space-y-4">
      ...
      <div className="flex gap-4 flex-col sm:flex-row sm:items-center justify-between">
        <PageHeader title="Edit Attributes" backHref="/categories/attributes" />
        <div className="w-32">
          <StatusSelect
      ...
      <div className="bg-white rounded-2xl p-4 sm:p-6 border border-gray-500/20">
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <FloatingInput label="Name" defaultValue="Color" />
            <FloatingInput
              label="Values"
              defaultValue="Black , Blue , Green , Yellow , White"
            />
          </div>
          ...
          <FloatingTextarea
            ...
            defaultValue="Color attributes for products."
            className="h-32"
          />
