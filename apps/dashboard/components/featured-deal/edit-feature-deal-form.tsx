...
const initialProducts: Product[] = Array.from({ length: 2 }).map((_, i) => ({
  id: `#${73423 + i}`,
  name: i === 0 ? "Sneakers" : "Jacket",
  image: `/images/flash-sale/${String(i + 1).padStart(2, "0")}.png`,
  category: i === 0 ? "Footwear" : "Fashion",
  price: i === 0 ? "$50" : "$80",
  status: "Publish",
}));

export default function EditFeatureDealForm() {
  ...
  return (
    <div className="w-full bg-white rounded-2xl mx-auto p-6 space-y-4">
      ...
      <div className="bg-white rounded-2xl pt-4 sm:pt-6 border border-gray-500/20">
