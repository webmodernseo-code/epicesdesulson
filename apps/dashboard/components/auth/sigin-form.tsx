      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        <div>
          ...
          <input
            ...
            required
            className="w-full h-11 px-3.5 rounded-xl border border-gray-300 text-sm font-medium text-gray-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all bg-white"
          />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              placeholder="••••••••••••"
              required
              className="w-full h-11 pl-3.5 pr-10 rounded-xl border border-gray-300 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all bg-white"
            />
            <button
              type="button"
        ...
        >
          <span>{loading ? "Vérification en cours..." : "Se connecter au tableau de bord"}</span>
